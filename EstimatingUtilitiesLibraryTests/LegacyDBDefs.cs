...
namespace EstimatingUtilitiesLibraryTests.LegacyDB_1_6
{
    ...
    internal class BidParametersTable : TableBase
    {
        ...
        public static Type ParameterType = typeof(Object);
    ...
    internal class DrawingTable : TableBase
    {
    ...
    internal class PageTable : TableBase
    {
    ...
    internal class VisualScopeTable : TableBase
    {
    ...
    internal class BidBidParametersTable : TableBase
    {
    ...
    internal class ControllerIOTable : TableBase
    {
    ...
    internal class IOModuleManufacturerTable : TableBase
    {
    ...
    internal class DeviceManufacturerTable : TableBase
    {
    ...
    internal class DrawingPageTable : TableBase
    {
    ...
    internal class PageVisualScopeTable : TableBase
    {
    ...
    internal class VisualScopeScopeTable : TableBase
    {
    ...
    internal class LocationScopeTable : TableBase
    {
    ...
    internal class ControllerManufacturerTable : TableBase
    {
    ...
    internal class CharacteristicScopeInstanceScopeTable : TableBase
    {
    ...
    public static class AllBidTables_1_6
    {
    ...
    public static class AllTemplateTables_1_6
    {
        public static List<object> Tables = new List<object>()
        {
            new MetadataTable(),
    ...
    public static class AllTables_1_6
    {
        public static List<object> Tables = new List<object>()
        {
            new MetadataTable(),
